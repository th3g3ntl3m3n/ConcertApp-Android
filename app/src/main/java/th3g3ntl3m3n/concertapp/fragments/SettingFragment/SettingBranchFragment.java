...
public class SettingBranchFragment extends Fragment {

    static FragmentPageListener listener;

    public static Fragment newInstance(FragmentPageListener l) {
        listener = l;
        return new SettingBranchFragment();
    }

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.setting_branch_fragment_layout, container, false);
    }
